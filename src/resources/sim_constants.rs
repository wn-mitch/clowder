...
impl Default for MagicConstants {
    fn default() -> Self {
        Self {
            ...
            ward_post_decay_multiplier: 0.5,
            ...
            shadow_fox_ward_repel_multiplier: 1.5,
...
impl Default for ScoringConstants {
    fn default() -> Self {
        Self {
            ...
            ward_corruption_emergency_bonus: 1.2,
...
impl Default for DispositionConstants {
    fn default() -> Self {
        Self {
            ...
            resting_complete_energy: 0.5,
            resting_complete_warmth: 0.50,
            sleep_duration_deficit_multiplier: 20.0,
            sleep_duration_base: 5,
            ...
            explore_range: 20,
            scent_downwind_dot_threshold: 0.3,
            scent_dense_forest_modifier: 0.25,
            scent_light_forest_modifier: 0.5,
            scent_base_range: 35.0,
