...
pub use sensors::{
    ...
    target_predictability_signal, update_prev_safety_deficit,
};
pub use target::{
...
/// electing dispositions the planner can't satisfy. Reader source is
/// `ContextBeliefs[DispositionExecution(kind)].predictability` post-290.
