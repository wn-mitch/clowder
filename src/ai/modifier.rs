...
pub const fn dse_id_for_action(action: crate::ai::Action) -> &'static str {
    ...
    match action {
        ...
        Action::Sleep => SLEEP,
        Action::Hunt => HUNT,
        // 100: Stalk/Pounce are EngagePrey-resolver phase sub-actions of
        // the Hunt DSE — set by `resolve_engage_prey` when the phase
        // transitions to Stalking/Pouncing, not L3-selectable. They
        // share the Hunt DSE id so IntentionMomentum continues to read
        // a Hunt commitment across the phase change.
        Action::Stalk => HUNT,
        Action::Pounce => HUNT,
...
pub fn action_for_ordinal(ord: f32) -> Option<crate::ai::Action> {
    ...
    Some(match idx {
        ...
        1 => Action::Sleep,
        2 => Action::Hunt,
        // 100: Stalk + Pounce inserted at idx 3 / 4, shifting
        // subsequent ordinals by +2.
        3 => Action::Stalk,
        4 => Action::Pounce,
        5 => Action::Forage,
        6 => Action::Wander,
        ...
        15 => Action::Build,
        16 => Action::Farm,
        17 => Action::HerbcraftGather,
        18 => Action::HerbcraftRemedy,
        19 => Action::HerbcraftSetWard,
        20 => Action::MagicScry,
        21 => Action::MagicDurableWard,
        22 => Action::MagicCleanse,
        23 => Action::MagicColonyCleanse,
        24 => Action::MagicHarvest,
        25 => Action::MagicCommune,
        26 => Action::Coordinate,
        27 => Action::Mentor,
        28 => Action::Mate,
        29 => Action::Caretake,
        30 => Action::Cook,
        ...
        37 => Action::WearItem,
        38 => Action::Craft,
        39 => Action::PetitionCoordinator,
        40 => Action::Vigil,
        41 => Action::GriefSit,
        42 => Action::ReleaseGrief,
        43 => Action::Wean,
        44 => Action::Teach,
        45 => Action::Release,
        // 367 — preservation Actions.
        46 => Action::DryFood,
        47 => Action::SmokeMeat,
        48 => Action::TendSmokingRack,
        // 450 — kitten beg-for-food Action.
        49 => Action::BegForFood,
        _ => return None,
    })
}
    ...
    fn constituent_dses_for_ordinal_matches_disposition_kind_constituent_actions() {
        ...
        fn action_to_dse_ids(action: Action) -> &'static [&'static str] {
            match action {
                Action::Eat => &[EAT],
                Action::Sleep => &[SLEEP],
                // 100: Stalk / Pounce are resolver-phase sub-actions of
                // Hunt — they share the Hunt DSE id for momentum and
                // disposition bookkeeping.
                Action::Hunt | Action::Stalk | Action::Pounce => &[HUNT],
                Action::Forage => &[FORAGE],
                Action::Socialize => &[SOCIALIZE],
                Action::GroomSelf => &[GROOM_SELF],
                Action::GroomOther => &[GROOM_OTHER],
