...
| H | 1 | Dedicated canary (`ShadowFoxAmbush ≤ 5` in `AGENTS.md`), defense pipeline stub (`docs/systems/shadowfox_wards.md`), perpetual tuning slot. Maximum ongoing tax. |
...
- **80–300** — expensive but valuable; earn the slot. Requires
  hypothesis + prediction per `AGENTS.md` §"Balance Methodology".
...
- `AGENTS.md` §"Balance Methodology" — the hypothesis / prediction /
  observation / concordance format required for ideas in the
  80–300 bucket.
- `AGENTS.md` §"Long-horizon coordination" — where to file the
