...
- A bugfix layer-walk needs the prior tickets / balance threads that ring the same bell. AGENTS.md "Bugfix discipline" mandates a structural-option menu; `just similar <ticket-id>` surfaces precedent for split / extend / rebind / retire decisions.
