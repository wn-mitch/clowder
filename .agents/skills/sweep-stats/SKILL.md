...
**Interpretation rule of thumb:** treat `significant` as "ship-blocking unless explained" and `drift` as "needs a hypothesis if it's on a characteristic metric per AGENTS.md."
