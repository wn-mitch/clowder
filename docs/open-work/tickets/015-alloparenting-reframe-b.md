...
- ✓ landed **156** (done, ai-substrate, score 0.90 (cross-cluster)) — Kitten starvation localized at (38,22) post-154 cascade — non-parent adults can…
- · **187** (ready, ai-substrate, score 0.88 (cross-cluster)) — Kittens starve in the post-184 soak — RetrieveFoodForKitten plan-fails dominate
- · **  1** (in-progress, —, score 0.88) — Explore dominance over targeted leisure
