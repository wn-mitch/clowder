...
- ✓ landed ** 46** (done, ai-substrate, score 0.84) — FightTarget combat-advantage uses skill-points difference, not damage-per-tick…
- · **145** (ready, ai-substrate, score 0.83) — Submit gesture DSE — appeasement infrastructure for IntraspeciesConflict.Fawn
- · **141** (ready, ai-substrate, score 0.83) — combat_winnability perception scalar — sibling to escape_viability
