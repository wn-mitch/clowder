...
- ✓ landed **193** (done, ai-substrate, score 0.85 (cross-cluster)) — PickingUp plan template routes to MaterialPile but eligibility latches on Carca…
- · ** 21** (blocked, buildings-zones, score 0.85) — Monuments — civic & memorial structures
