...
- ✓ landed ** 71** (done, planning-substrate, score 0.86 (cross-cluster)) — Planning-substrate hardening — gird against the stuck-cat bug class (sub-epic)
- ✓ landed **247** (done, ai-substrate, score 0.86 (cross-cluster)) — Diagnose IntentionMomentum + floor-removal PickUp-lock cliff
- · **400** (blocked, social-coordination, score 0.85 (cross-cluster)) — L2 ParentingActivity — implementation per 399 design
