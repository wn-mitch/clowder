...
- · **142** (ready, ai-substrate, score 0.82 (cross-cluster)) — IntraspeciesConflictResponseFreeze — hold-position low-body-posture social vale…
- ✓ landed **117** (done, ai-substrate, score 0.82 (cross-cluster)) — Characterize social-warmth max shift under 047 substrate (Phase 3 surfaced -96%…
- · ** 40** (ready, —, score 0.82) — Disposition shift after 036 collapsed Courtship / Grooming / Mythic-texture con…
