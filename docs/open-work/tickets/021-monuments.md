...
- ✓ landed ** 38** (done, —, score 0.88) — "MaterialsDelivered routing gap → full Pickup/Carry/Deliver pipeline (infrastru…
- ✓ landed ** 71** (done, planning-substrate, score 0.88 (cross-cluster)) — Planning-substrate hardening — gird against the stuck-cat bug class (sub-epic)
- ✓ landed **169** (done, ai-substrate, score 0.87 (cross-cluster)) — Author HasConstructionSite + HasDamagedBuilding markers (buildings.rs)
