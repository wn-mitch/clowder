...
- ✓ landed ** 62** (done, belief-perception, score 0.90) — Prey-species split — per-species scent maps (§5.6.3 row #5)
- ✓ landed **260** (done, wildlife, score 0.90 (cross-cluster)) — Fox scent-marking signposts — territorial boundaries without ward keying
- ✓ landed **312** (done, belief-perception, score 0.90) — fox-approach-corridor perception axis for ward placement (301 FO-2)
