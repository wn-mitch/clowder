...
- ✓ landed **231** (done, ai-substrate, score 0.84 (cross-cluster)) — Strengthen pickup-class substrate — capacity markers + body-state subscription
- · **191** (ready, items-crafting, score 0.83) — Tune PickingUp scavenge_urgency curve + add scenario test (185 follow-on)
- ✓ landed **193** (done, ai-substrate, score 0.83 (cross-cluster)) — PickingUp plan template routes to MaterialPile but eligibility latches on Carca…
