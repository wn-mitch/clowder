...
- ✓ landed **178** (done, ai-substrate, score 0.83 (cross-cluster)) — Balance-tune disposal DSEs from default-zero (176 follow-on)
- ✓ landed ** 38** (done, —, score 0.83) — "MaterialsDelivered routing gap → full Pickup/Carry/Deliver pipeline (infrastru…
- ✓ landed **176** (done, ai-substrate, score 0.83 (cross-cluster)) — cats need real inventory reasoning — trash, build-more-stores, satiation-aware…
