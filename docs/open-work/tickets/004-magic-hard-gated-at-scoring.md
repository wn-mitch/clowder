...
- ✓ landed **155** (done, ai-substrate, score 0.82 (cross-cluster)) — Split Crafting into Herbalism / Witchcraft / Cooking — retire CraftingHint
- ✓ landed **175** (done, ai-substrate, score 0.80 (cross-cluster)) — GoalUnreachable plan-failure root-cause investigation (172 follow-on)
- ✓ landed **121** (done, substrate-over-override, score 0.80 (cross-cluster)) — Cats stand around for ~1500 ticks at game start until first kitchen lands
