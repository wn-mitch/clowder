...
- · **270** (ready, combat-threat, score 0.85) — EngageThreat split from Patrol DSE (256 R6 follow-on with Belief + ActionAfford…
- · **268** (ready, combat-threat, score 0.84) — Hide DSE — wire C3 Belief + ActionAffordance for general threat-response (door-…
- · **170** (ready, combat-threat, score 0.84) — HideEligible authoring system (Hide DSE Phase 2)
