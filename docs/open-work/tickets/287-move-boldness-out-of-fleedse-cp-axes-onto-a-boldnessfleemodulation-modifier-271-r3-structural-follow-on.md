...
- ✓ landed **255** (done, ai-substrate, score 0.87 (cross-cluster)) — ThreatProximityAdrenalineFlee Flee-axis calibration audit (post-252 readable)
- ✓ landed **224** (done, pathfinder-risk-awareness, score 0.87 (cross-cluster)) — boldness-conditioned path risk
- · **317** (blocked, ai-substrate, score 0.85 (cross-cluster)) — retire flee_threat_distance Power-Invert if frame-diff shows redundancy with Af…
