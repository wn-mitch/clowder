...
- ✓ landed **121** (done, substrate-over-override, score 0.89 (cross-cluster)) — Cats stand around for ~1500 ticks at game start until first kitchen lands
- ✓ landed **178** (done, ai-substrate, score 0.88 (cross-cluster)) — Balance-tune disposal DSEs from default-zero (176 follow-on)
