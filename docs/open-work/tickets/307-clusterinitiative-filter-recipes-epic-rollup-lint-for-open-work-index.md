...
- · ** 60** (in-progress, ai-substrate, score 0.87 (cross-cluster)) — AI substrate refactor — program epic
- · ** 16** (in-progress, items-crafting, score 0.86 (cross-cluster)) — Crafting — items, recipes, stations (epic dashboard)
- · **128** (in-progress, ai-substrate, score 0.85 (cross-cluster)) — HTN method composition — epic
