...
- ✓ landed **331** (done, ai-substrate, score 0.93) — Leadership aspiration_milestone_wrapper + emits tables
- ✓ landed **327** (done, ai-substrate, score 0.92) — Combat aspiration_milestone_wrapper + emits tables
