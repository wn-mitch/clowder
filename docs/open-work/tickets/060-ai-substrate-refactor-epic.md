...
| [128](128-htn-method-composition.md) | ready | Cluster C | HTN method composition over `HeldIntention.goal` (126 landed) |
...
| [317](317-retire-flee-threat-distance-power-invert-if-frame-diff-shows-redundancy-with-affordanceflee.md) | ready | §261 / 263 | Retire `flee_threat_distance` if frame-diff shows redundancy |
