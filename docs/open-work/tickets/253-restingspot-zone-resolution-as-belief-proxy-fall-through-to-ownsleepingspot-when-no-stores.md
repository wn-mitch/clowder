...
- · **374** (ready, ai-substrate, score 0.85) — Shelter as housing-security belief — per-cat home-den facet, replace per-tick s…
- ✓ landed **  6** (done, ai-substrate, score 0.84) — Cluster-B shared spatial slow-state closeout
- ✓ landed ** 87** (done, ai-substrate, score 0.84) — Interoceptive perception substrate
