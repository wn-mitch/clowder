...
- · **235** (ready, items-crafting, score 0.87 (cross-cluster)) — Smart deposit routing for clutter clearance
- ✓ landed **247** (done, ai-substrate, score 0.86) — Diagnose IntentionMomentum + floor-removal PickUp-lock cliff
- · **343** (parked, ai-substrate, score 0.86) — Emit-cooldown discipline — per-emit cooldown_ticks
