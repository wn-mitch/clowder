...
|---|---|---|---|
| `src/systems/disposition.rs:299-351` | `CriticalHealth`/`Starvation`/`Exhaustion`/`CriticalSafety` interrupts force per-tick replan; same disposition often re-picked while damage accumulates | continuous health/safety/hunger/energy deficits as DSE axes + jerk curves on Sleep/Eat/Flee | **landed via [047](../landed/047-critical-health-interrupt-treadmill.md)** (2026-05-01) — phase 1 substrate shipped; per-interrupt retirement carved out into [106](106-hunger-urgency-modifier.md) (Starvation) / [107](107-exhaustion-pressure-modifier.md) (Exhaustion) / [108](108-threat-proximity-adrenaline.md) (CriticalSafety) / [110](110-thermal-distress-modifier.md) (thermal); final retirement under [119](119-critical-health-interrupt-retire.md) (blocked-by 118) |
| `src/systems/disposition.rs:254-276` | `ThreatDetected` forces `Action::Flee`, overriding higher-scoring Guarding | threat-proximity axis on Flee + threat-presence marker | **[103](103-escape-viability-scalar.md)** (ready) + **[108](108-threat-proximity-adrenaline.md)** (ready, blocked-by 103) — substrate primitives the ThreatDetected fork needs |
...
| Location | Hack | Lever | Ticket |
|---|---|---|---|
| `src/systems/disposition.rs:305-317` | `Resting`/`Hunting`/`Foraging` exempt from hunger/energy interrupts | Rao-Georgeff §7.2 commitment/momentum modifier (047 phase 1 shipped the primitive); per-exemption retirement under 112 | **[112](112-disposition-exemption-list-retire.md)** (ready) — carved out of 047; retires the lists once §7.2 momentum fully covers their job |
| `src/systems/disposition.rs:319-342` | Guards exempt from threat interrupts | Guarding DSE's eligibility re-evaluates threat severity natively | 112 (covers all four exemption lists) |
...
| 047's `Starvation` interrupt | `HungerUrgency` modifier substrate axis | open under [106](106-hunger-urgency-modifier.md) (ready) |
| 047's `Exhaustion` interrupt | `ExhaustionPressure` modifier substrate axis | open under [107](107-exhaustion-pressure-modifier.md) (ready) |
| 047's `CriticalSafety` interrupt | `ThreatProximityAdrenaline` modifier — depends on 103's `escape_viability` primitive | open under [108](108-threat-proximity-adrenaline.md) (ready, blocked-by 103) |
| 047 thermal interrupt class | `ThermalDistress` modifier substrate axis | open under [110](110-thermal-distress-modifier.md) (ready) |
| 047 fight/freeze valence buildout | `escape_viability` perception scalar (103) + `Hide/Freeze` DSE (104) feeding 102 (fight branch) and 105 (freeze branch) and 109 (intraspecies-conflict response) | open under [102](102-acute-health-adrenaline-fight-branch.md) / [103](103-escape-viability-scalar.md) / [104](104-hide-freeze-dse.md) / [105](105-acute-health-adrenaline-freeze-branch.md) / [109](109-intraspecies-conflict-response.md) |
| 047 modifier-vs-momentum doctrine + interrupt invariant | jerk-curve doctrine doc + `modifier-lift gated by plan-completion-momentum` design | open under [113](113-interrupt-invariant-doc.md) (ready) + [118](118-modifier-lift-vs-plan-completion-momentum.md) (ready) + [117](117-social-warmth-vs-self-care-tradeoff.md) (ready, blocked-by 118) |
| 088 retirement (once 106/107/110 cover its surface) | kind-specific modifiers replacing the composite distress lift | open under [111](111-088-body-distress-promotion-retire.md) (blocked-by 106 + 107 + 110) |
...
| [099](099-modifier-feature-emission.md) | ready (047 unblocked 2026-05-01) | substrate-quality follow-on from 088 — emit a `Feature` from every Modifier so canary surface covers Modifier activation uniformly |
| [102](102-acute-health-adrenaline-fight-branch.md) | ready (blocked-by 103) | 047 follow-on — AcuteHealthAdrenaline Fight branch valence (cornered/maternal-defense) |
| [103](103-escape-viability-scalar.md) | ready | 047 follow-on — `escape_viability` perception scalar; first-class predicate for adrenaline-valence selection |
| [104](104-hide-freeze-dse.md) | ready | 047 follow-on — Hide/Freeze DSE (predator-avoidance third valence) |
| [105](105-acute-health-adrenaline-freeze-branch.md) | blocked-by 103+104 | 047 follow-on — AcuteHealthAdrenaline Freeze branch (overmatched-predator response) |
| [106](106-hunger-urgency-modifier.md) | ready | 047 follow-on — `HungerUrgency` modifier; substrate axis retiring `Starvation` interrupt |
| [107](107-exhaustion-pressure-modifier.md) | ready | 047 follow-on — `ExhaustionPressure` modifier; substrate axis retiring `Exhaustion` interrupt |
| [108](108-threat-proximity-adrenaline.md) | ready (blocked-by 103) | 047 follow-on — `ThreatProximityAdrenaline` modifier; substrate axis retiring `CriticalSafety` interrupt |
| [109](109-intraspecies-conflict-response.md) | ready (blocked-by 104) | 047 follow-on — full four-valence (fight/flight/freeze/fawn) social-conflict response |
| [110](110-thermal-distress-modifier.md) | ready | 047 follow-on — `ThermalDistress` modifier; substrate axis for thermal interrupts + shelter-seeking |
| [111](111-088-body-distress-promotion-retire.md) | blocked-by 106+107+110 | 047 follow-on — retire 088's composite `BodyDistressPromotion` once kind-specific modifiers cover its surface |
| [112](112-disposition-exemption-list-retire.md) | ready | 047 follow-on — retire per-disposition exemption lists (Resting/Hunting/Foraging/Guarding) once §7.2 momentum covers their job |
| [113](113-interrupt-invariant-doc.md) | ready | 047 follow-on — codify the interrupt invariant + lurch-vs-pressure modifier doctrine |
...
| [119](119-critical-health-interrupt-retire.md) | blocked-by 118 | 047 follow-on — final retirement of `CriticalHealth` interrupt; the closing step of the substrate-over-override chain for ticket 047 |
...
**Total open: 24** (0 in-progress, 18 ready, 4 blocked, 2 parked) — after 027 closeout, 088 land, 094 land, 121 land, 122/123 sibling carveouts land, 076 retired without implementation, **047 phase 1 landed 2026-05-01**, and the 047 follow-on cluster (102/103/104/105/106/107/108/109/110/111/112/113/117/118/119) opened per the antipattern-migration-follow-ups rule. 099 unblocked when 047 landed.

Status breakdown:
- **Ready (18):** 047-followons 102/103/104/106/107/108/109/110/112/113/117/118 (12) + 089 + 090 + 096 + 097 + 098 + 099
- **Blocked (4):** 027b (blocked-by 071), 105 (blocked-by 103+104), 111 (blocked-by 106+107+110), 119 (blocked-by 118)
- **Parked (2):** 058, 081
...
Opened 2026-04-30. Inventory cataloged 11 child tickets initially. As of 2026-05-01 (post 027/088/094/121/122/123 land, 076 retired, **047 phase 1 landed**, 047 follow-on cluster 102-119 opened): **24 open** (0 in-progress, 18 ready, 4 blocked, 2 parked) plus the canonical exemplars 087 / 091 / 092 / 094 / 121 / 122 / 123 / 047. Recommended ordering:
...
3. ~~Promote 088~~ (unblocked 2026-05-01).
4. ~~Land 088~~ (landed 2026-05-01) — `BodyDistressPromotion` Modifier as the substrate prerequisite for 047.
5. ~~058 (warm-up)~~ — parked 2026-04-30.
6. 027/027b/078 thread runs in parallel under 071. ~~027 closed 2026-05-01.~~
7. ~~Re-evaluate 076 with the lens.~~ Retired 2026-05-01.
8. Land 096 (materials_available split) + 097 (non-cat planner audit) to complete 092's structural cure across all GOAP domains; 098 codifies the substrate-vs-search-state boundary doctrine.
9. ~~Land 094 (Eat-vs-Forage)~~ — landed 2026-04-30.
10. ~~Land 121 + 122 + 123~~ (landed 2026-05-01).
11. ~~Land 047 phase 1~~ (landed 2026-05-01) — acute-health-adrenaline substrate + jerk curves + per-disposition exemption framework. **Phase 2** = the carved-out follow-on cluster.
12. **Next active batch (047 follow-ons, parallelizable on no-deps tickets):**
    - **103** (`escape_viability` scalar, no deps) and **104** (Hide/Freeze DSE, no deps) — substrate primitives that unblock 102 / 105 / 108 / 109. Land first.
    - **106** (`HungerUrgency`), **107** (`ExhaustionPressure`), **110** (`ThermalDistress`) — kind-specific modifiers retiring the Starvation / Exhaustion / thermal interrupts. No deps; can run in parallel with 103/104.
    - **112** (retire per-disposition exemption lists), **113** (interrupt-invariant doc), **118** (modifier-lift vs plan-completion momentum) — doctrine + cleanup tickets, no deps.
    - **099** (Modifier feature emission) — unblocked when 047 landed; substrate-quality canary surface for all modifiers including 088, 094, 047's adrenaline modifiers.
    - After substrate primitives land: **102** (Fight valence, blocked-by 103), **105** (Freeze branch, blocked-by 103+104), **108** (ThreatProximityAdrenaline, blocked-by 103), **109** (intraspecies-conflict, blocked-by 104).
    - After all kind-specific modifiers ship: **111** (retire 088, blocked-by 106+107+110), **117** (social-warmth tradeoff, blocked-by 118), **119** (retire CriticalHealth interrupt, blocked-by 118).
13. **Re-evaluate 081 with the lens before unparking** — coordinator-side directive-failure demotion still needs framing as a substrate axis (the colony-level analogue of 123's per-cat axis); not auto-retired since coordinator scope is materially different.
...
- `rg '## Substrate-over-override pattern' docs/open-work/tickets/ | wc -l` matches open child count (currently 24).
