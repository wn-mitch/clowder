...
- · **352** (ready, wildlife, score 0.89) — Hawk + snake GOAP narrative templates (HawkSpottedPrey, DiveLanded, SnakeStruck…
- · **348** (ready, wildlife, score 0.89) — Hawk + snake balance iteration — first tuning pass post-GOAP cutover
- · **350** (ready, tooling-diagnostics-ui, score 0.83 (cross-cluster)) — Rebuild sensitivity-map post-wildlife-GOAP (25 new constants)
