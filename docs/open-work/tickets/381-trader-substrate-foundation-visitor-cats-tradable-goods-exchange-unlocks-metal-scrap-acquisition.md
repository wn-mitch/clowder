...
- · **378** (blocked, ai-perception, score 0.87 (cross-cluster)) — colony material-demand axis: perceivable material-need substrate (FoodStores tw…
- · **334** (blocked, items-crafting, score 0.86 (cross-cluster)) — Stealth-cloak crafting recipe + WearItem resolver
- · ** 41** (ready, items-crafting, score 0.86 (cross-cluster)) — Founding wagon-dismantling haul — balance the early-game cost so cats don't sta…
