...
- · **  1** (in-progress, —, score 0.85) — Explore dominance over targeted leisure
- ✓ landed **210** (done, balance, score 0.85 (cross-cluster)) — tune mentor_food_security_weight
- · ** 26** (blocked, —, score 0.85) — Apprenticeship XP-boost on per-skill Skills component
