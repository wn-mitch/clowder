...
- ✓ landed **397** (done, ai-substrate, score 0.90 (cross-cluster)) — rear_kitten arc clean completion exposes kitten survival regression
- · **273** (parked, life-cycle, score 0.89) — Caretake plans complete but KittenFed never fires — kitten starvation chronic
- ✓ landed **395** (done, ai-substrate, score 0.88 (cross-cluster)) — rear_kitten arc — decouple Release from KittenDependency removal
