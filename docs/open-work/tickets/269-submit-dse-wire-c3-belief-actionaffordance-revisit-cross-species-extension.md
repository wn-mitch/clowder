...
- · **265** (ready, wildlife, score 0.91 (cross-cluster)) — Wildlife symmetric DSE consumers wire belief + affordance (fox, hawk, snake, sh…
- · **270** (ready, combat-threat, score 0.89) — EngageThreat split from Patrol DSE (256 R6 follow-on with Belief + ActionAfford…
