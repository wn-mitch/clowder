...
- · **  1** (in-progress, ai-substrate, score 0.87 (cross-cluster)) — Explore dominance over targeted leisure
- ✓ landed ** 46** (done, ai-substrate, score 0.86 (cross-cluster)) — FightTarget combat-advantage uses skill-points difference, not damage-per-tick…
