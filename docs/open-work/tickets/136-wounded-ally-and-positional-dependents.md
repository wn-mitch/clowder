...
- ✓ landed ** 49** (done, —, score 0.87 (cross-cluster)) — §9.2 faction overlay markers
- · **219** (ready, ai-substrate, score 0.86) — shared recent-ambush event marker
- · **173** (parked, ai-substrate, score 0.86) — IsHerbalist / IsSpiritualist / HasCorruptionNearby capability markers (155 foll…
