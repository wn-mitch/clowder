...
- · **138** (ready, substrate-migration, score 0.86 (cross-cluster)) — Phase 1 — MovementBudget per entity + escape_viability mobility term
- · **136** (ready, ai-substrate, score 0.86) — WoundedAlly marker + positional dependent-proximity for escape_viability
