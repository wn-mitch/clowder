...
- ✓ landed **210** (done, balance, score 0.90 (cross-cluster)) — tune mentor_food_security_weight
- ✓ landed **189** (done, ai-substrate, score 0.89) — Post-178 food_available regression — layer-walk diagnosis
- ✓ landed **211** (done, balance, score 0.88 (cross-cluster)) — tune coordinate_food_security_weight
