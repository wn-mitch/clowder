...
- ✓ landed **183** (done, ai-substrate, score 0.90) — Paired-axis lift on higher-tier DSEs OR Patrol-collision investigation (181 fol…
- ✓ landed **163** (done, ai-substrate, score 0.87) — Migrate the 9 apply_*_bonus passes into §3.5.1 modifiers (full-batch)
