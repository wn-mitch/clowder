...
- ✓ landed **160** (done, ai-substrate, score 0.85 (cross-cluster)) — Substrate stub catalogue + lint — fail the build on orphan markers
- · **227** (ready, process-discipline, score 0.85) — coordinator-eligible focal-cat for Coordinate frame-diff parity
