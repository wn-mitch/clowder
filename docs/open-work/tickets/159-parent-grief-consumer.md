...
- ✓ landed **116** (done, emotional-fidelity, score 0.89 (cross-cluster)) — Bereavement — bond-specific grief modifier on partner/friend death
- · **204** (ready, ai-substrate, score 0.88) — Kitten-starvation cluster surfaced by 119 substrate activation — bonding/mating…
- · **187** (ready, ai-substrate, score 0.87) — Kittens starve in the post-184 soak — RetrieveFoodForKitten plan-fails dominate
