...
- · **239** (ready, life-cycle, score 0.89) — Grief modeling + rest-at-grave chain — LostBonds + grave-as-rest-target via exi…
- · **399** (ready, social-coordination, score 0.87 (cross-cluster)) — L2 ParentingActivity — express non-primary-caretaker parent roles per §7.M.2 (d…
- · ** 15** (parked, life-cycle, score 0.87) — Alloparenting Reframe B — mama drops kitten at hearth near resting elder
