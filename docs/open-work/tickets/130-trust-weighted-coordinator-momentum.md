...
- · **393** (blocked, social-coordination, score 0.85) — C4 coordinator dynastic seeding (pre-sim leadership patterns produce t=0 coordi…
- ✓ landed **247** (done, ai-substrate, score 0.84 (cross-cluster)) — Diagnose IntentionMomentum + floor-removal PickUp-lock cliff
- ✓ landed **154** (done, ai-substrate, score 0.83 (cross-cluster)) — Extract Mentoring from Socializing — split DispositionKind so MentoredCat fires
