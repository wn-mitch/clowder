...
- · **242** (ready, belief-perception, score 0.82) — Body-cue substrate (Disposition → observable markers)
- · **267** (ready, combat-threat, score 0.82 (cross-cluster)) — Conflict-low DSEs — Threaten / Posture / Hiss escalation rungs (cheap pre-Fight…
- ✓ landed **282** (done, ai-substrate, score 0.81 (cross-cluster)) — Temporal-integration doctrine for perception signals — decay stale, accumulate…
