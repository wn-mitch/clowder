...
- ✓ landed **300** (done, balance, score 0.88 (cross-cluster)) — refine ward placement candidate-generation step (285+296+297 architectural foll…
- ✓ landed **297** (done, ai-substrate, score 0.87 (cross-cluster)) — ward placement needs fox-patrol-topology perception axis (285 follow-on)
- ✓ landed **312** (done, belief-perception, score 0.87 (cross-cluster)) — fox-approach-corridor perception axis for ward placement (301 FO-2)
