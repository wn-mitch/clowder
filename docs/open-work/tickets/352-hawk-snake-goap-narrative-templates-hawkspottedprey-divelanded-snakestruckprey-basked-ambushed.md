...
- · **348** (ready, wildlife, score 0.90) — Hawk + snake balance iteration — first tuning pass post-GOAP cutover
- · **349** (ready, wildlife, score 0.89) — Hawk + snake perceptual-fact docs (hawk-ecology.md, snake-ecology.md)
- · **350** (ready, tooling-diagnostics-ui, score 0.84 (cross-cluster)) — Rebuild sensitivity-map post-wildlife-GOAP (25 new constants)
