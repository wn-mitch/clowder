...
- ✓ landed **223** (done, pathfinder-risk-awareness, score 0.86 (cross-cluster)) — cat paths respect fox-scent + corruption
- · **228** (in-progress, pathfinder-risk-awareness, score 0.85 (cross-cluster)) — cat route-cost field as L1 perception + Field Consideration variant
- ✓ landed **224** (done, pathfinder-risk-awareness, score 0.85 (cross-cluster)) — boldness-conditioned path risk
