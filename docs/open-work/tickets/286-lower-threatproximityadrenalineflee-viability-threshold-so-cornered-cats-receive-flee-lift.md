...
- ✓ landed **255** (done, ai-substrate, score 0.88) — ThreatProximityAdrenalineFlee Flee-axis calibration audit (post-252 readable)
- ✓ landed **230** (done, pathfinder-risk-awareness, score 0.87 (cross-cluster)) — Carve DispositionKind::Fleeing + substrate-aware flee picker (close anxiety-int…
- ✓ landed **102** (done, ai-substrate, score 0.87) — AcuteHealthAdrenaline Fight branch — cornered/maternal-defense valence
