...
- · ** 84** (parked, items-crafting, score 0.89) — Farm DSE — tie scoring to herb/ward stockpile demand so gardens stay productive…
- ✓ landed **155** (done, ai-substrate, score 0.87 (cross-cluster)) — Split Crafting into Herbalism / Witchcraft / Cooking — retire CraftingHint
- · **173** (parked, ai-substrate, score 0.87 (cross-cluster)) — IsHerbalist / IsSpiritualist / HasCorruptionNearby capability markers (155 foll…
