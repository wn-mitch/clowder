...
- · ** 35** (ready, —, score 0.91 (cross-cluster)) — Burial — implement the §5 broaden-sideways capability so the continuity canary…
- ✓ landed **189** (done, ai-substrate, score 0.86) — Post-178 food_available regression — layer-walk diagnosis
- ✓ landed **184** (done, ai-substrate, score 0.85) — Hunt kill→stockpile pipeline regressed under L3 bandwidth pressure (root cause…
