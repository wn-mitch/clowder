...
- · **283** (ready, belief-perception, score 0.89 (cross-cluster)) — Split fox-scent perception into territorial-mark and recent-presence channels
- ✓ landed ** 23** (done, wildlife, score 0.88 (cross-cluster)) — Shadowfox motivations distinct from normal foxes
- ✓ landed **285** (done, balance, score 0.88 (cross-cluster)) — tune ward anchor weights — magnitude iteration
