...
- · ** 18** (blocked, magic-mythic, score 0.87 (cross-cluster)) — Ruin clearings (corruption nodes, PMD-flavored)
- · **334** (blocked, items-crafting, score 0.85) — Stealth-cloak crafting recipe + WearItem resolver
- ✓ landed **184** (done, ai-substrate, score 0.85 (cross-cluster)) — Hunt kill→stockpile pipeline regressed under L3 bandwidth pressure (root cause…
