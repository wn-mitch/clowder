...
- ✓ landed **163** (done, ai-substrate, score 0.87 (cross-cluster)) — Migrate the 9 apply_*_bonus passes into §3.5.1 modifiers (full-batch)
- · **  1** (in-progress, —, score 0.86 (cross-cluster)) — Explore dominance over targeted leisure
- ✓ landed **  6** (done, —, score 0.85 (cross-cluster)) — Cluster-B shared spatial slow-state closeout
