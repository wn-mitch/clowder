...
- · **287** (ready, combat-threat, score 0.82 (cross-cluster)) — Move boldness out of FleeDse CP axes onto a BoldnessFleeModulation modifier (27…
- ✓ landed **258** (done, C, score 0.82 (cross-cluster)) — C3 worked design — subjective belief substrate (mental models + facets + eviden…
- ✓ landed **261** (done, ai-substrate, score 0.82) — ActionAffordances substrate — per-action success scalars + ActionKind enum + he…
