...
- ✓ landed **247** (done, ai-substrate, score 0.87) — Diagnose IntentionMomentum + floor-removal PickUp-lock cliff
- · **  1** (in-progress, ai-substrate, score 0.86) — Explore dominance over targeted leisure
- · **249** (parked, ai-substrate, score 0.86) — Extend DispositionFailureCooldown coverage to Resting/Guarding/PickingUp et al.…
