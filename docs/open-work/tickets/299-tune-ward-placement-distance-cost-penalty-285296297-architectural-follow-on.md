...
- ✓ landed ** 45** (done, buildings-zones, score 0.91) — Ward perimeter placement via L1 influence maps
- ✓ landed **220** (done, ai-substrate, score 0.89 (cross-cluster)) — ward placement targets ambush clusters
- ✓ landed **312** (done, belief-perception, score 0.88 (cross-cluster)) — fox-approach-corridor perception axis for ward placement (301 FO-2)
