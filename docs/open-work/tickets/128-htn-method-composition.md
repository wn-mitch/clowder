...
| [334](../landed/334-stealth-cloak-crafting-recipe-wearitem-resolver.md) | landed 2026-05-27 | §G Tier 2 | WearItem resolver + Craft frame-pin seam; flipped `acquire_stealth_via_self_craft` to Live (recipe/slot/effect deduped against 369/017/477). Commission split to #481 |
| [481](481-wire-acquire-stealth-via-commission-htn-method-coordinator-commission-substrate.md) | blocked-by [381] | §G Tier 2 follow-on | Wire `acquire_stealth_via_commission` Live — PetitionCoordinator resolver + `ordered_item_ready` order-fulfilment loop (needs trader substrate #381). Split from #334 |
