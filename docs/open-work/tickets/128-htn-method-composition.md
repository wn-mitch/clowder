...
- · **127** (blocked, C, score 0.85) — Joint-intention substrate for two-cat practices
- ✓ landed **175** (done, ai-substrate, score 0.84 (cross-cluster)) — GoalUnreachable plan-failure root-cause investigation (172 follow-on)
- ✓ landed **151** (done, process, score 0.83 (cross-cluster)) — Bugfix discipline — force a structural candidate in every fix-shape decision tr…
