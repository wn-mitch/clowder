...
| Batch D — Tier 2 glue | §G | 🔄 blocked on #320 + external substrate | [332](332-grief-vigil-action-vocabulary.md) [333](333-kitten-rearing-action-vocabulary.md) [334](334-stealth-cloak-crafting-recipe-wearitem-resolver.md) | 3-way as external substrate arrives |
...
| [332](332-grief-vigil-action-vocabulary.md) | blocked-by 320,322 | §G Tier 2 | Vigil / GriefSit primitives + Grave-target picker; flips `mourn_at_grave` to Live |
| [333](333-kitten-rearing-action-vocabulary.md) | blocked-by 320,322 | §G Tier 2 | Wean / Teach / Release primitives keyed to KittenDependency; flips `rear_kitten` to Live |
