...
- · **380** (blocked, items-crafting, score 0.86) — cat-death byproducts: heirloom-eligible bones and fur-tuft for 370 Heirloom + 3…
- · ** 18** (blocked, magic-mythic, score 0.85 (cross-cluster)) — Ruin clearings (corruption nodes, PMD-flavored)
...
- 2026-05-19: accuracy audit pass — blocked-by 375 ready; status blocked verified; design references exist (crafting.md)
