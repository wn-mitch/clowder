...
- ✓ landed **247** (done, ai-substrate, score 0.90) — Diagnose IntentionMomentum + floor-removal PickUp-lock cliff
- · **249** (parked, ai-substrate, score 0.89) — Extend DispositionFailureCooldown coverage to Resting/Guarding/PickingUp et al.…
- ✓ landed ** 73** (done, ai-substrate, score 0.89) — Wave 2 substrate hardening
