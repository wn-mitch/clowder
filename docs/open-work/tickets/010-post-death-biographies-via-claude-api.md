...
- ✓ landed ** 14** (done, —, score 0.82) — "§4.2 State marker trio — `InCombat` / `OnCorruptedTile` / `OnSpecialTerrain` a…
- ✓ landed ** 13** (done, —, score 0.80) — Spec-follow-on debts umbrella retirement
- · **180** (ready, world-ecology, score 0.80 (cross-cluster)) — Death-stamp / scent-anchor at kill sites (176 follow-on)
