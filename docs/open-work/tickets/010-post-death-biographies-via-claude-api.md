...
- ✓ landed ** 54** (done, magic-mythic, score 0.84) — §7.7.c Fate event-vocabulary expansion — Calling, destiny, fated-pair convergen…
- · **391** (blocked, magic-mythic, score 0.84) — Narrative-template historical reference (pre-sim figures cited in first sim-wee…
