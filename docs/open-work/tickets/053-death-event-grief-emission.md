...
- ✓ landed **116** (done, emotional-fidelity, score 0.87 (cross-cluster)) — Bereavement — bond-specific grief modifier on partner/friend death
- · **159** (ready, ai-substrate, score 0.87 (cross-cluster)) — Parent grief consumer for kitten / dependent death
- · **129** (blocked, C, score 0.83 (cross-cluster)) — Care DSEs over perceivable intentions
