...
- · **180** (ready, belief-perception, score 0.84 (cross-cluster)) — Death-stamp / scent-anchor at kill sites (176 follow-on)
- ✓ landed **332** (done, life-cycle, score 0.83) — Grief-vigil action vocabulary — flip mourn_at_grave to Live
- · **239** (ready, life-cycle, score 0.83) — Grief modeling + rest-at-grave chain — LostBonds + grave-as-rest-target via exi…
