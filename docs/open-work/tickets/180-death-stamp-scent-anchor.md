...
- · ** 64** (ready, —, score 0.86 (cross-cluster)) — Carcass-scent consumer cutover — replace observer_smells_at (§5.6.3 row #6)
- · **219** (ready, ai-substrate, score 0.86 (cross-cluster)) — shared recent-ambush event marker
- · **159** (ready, ai-substrate, score 0.86 (cross-cluster)) — Parent grief consumer for kitten / dependent death
