...
- ✓ landed ** 48** (done, belief-perception, score 0.86) — "Phase 2C CarcassScentMap, the §5.6.3 #6 influence map"
- ✓ landed **284** (done, balance, score 0.85 (cross-cluster)) — tune ward placement ambush + carcass anchor weights
