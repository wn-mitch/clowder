...
- ✓ landed ** 46** (done, ai-substrate, score 0.87 (cross-cluster)) — FightTarget combat-advantage uses skill-points difference, not damage-per-tick…
- · **294** (ready, belief-perception, score 0.87) — RecentAmbushMap retirement — colony Resource moves to per-cat LocationBeliefs.r…
