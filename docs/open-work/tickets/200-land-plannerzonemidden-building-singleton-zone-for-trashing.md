...
- ✓ landed **382** (done, ai-substrate, score 0.82 (cross-cluster)) — Influence-map based colony-district placement — retire find_building_placement…
- · ** 21** (blocked, buildings-zones, score 0.81) — Monuments — civic & memorial structures
- · **235** (ready, items-crafting, score 0.81 (cross-cluster)) — Smart deposit routing for clutter clearance
