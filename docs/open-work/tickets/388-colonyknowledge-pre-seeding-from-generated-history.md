...
- ✓ landed **  7** (done, ai-substrate, score 0.85 (cross-cluster)) — Deliberation-layer (Cluster C)
- · **389** (ready, tooling-diagnostics-ui, score 0.85 (cross-cluster)) — History-gen throughput uplift (10-100x via rendering/narrative/diagnostic gatin…
- ✓ landed **308** (done, belief-perception, score 0.84) — Colony reserves belief — mental-model facet tracking thornbriar / remedy-herb s…
