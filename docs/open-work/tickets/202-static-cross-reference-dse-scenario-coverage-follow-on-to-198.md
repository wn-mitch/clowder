...
- · **217** (ready, process-discipline, score 0.83) — scenario marker-snapshot wiring as a discipline requirement
- ✓ landed **162** (done, tooling, score 0.82 (cross-cluster)) — Scenario harness — fast deterministic "what wins" experiments for AI decision t…
- · ** 86** (ready, balance, score 0.82 (cross-cluster)) — Find a triggering scenario for Farm DSE canary (CropTended / CropHarvested)
