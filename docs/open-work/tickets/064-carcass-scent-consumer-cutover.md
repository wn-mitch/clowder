...
- · ** 62** (ready, —, score 0.91) — Prey-species split — per-species scent maps (§5.6.3 row #5)
- ✓ landed **223** (done, pathfinder-risk-awareness, score 0.88 (cross-cluster)) — cat paths respect fox-scent + corruption
- ✓ landed **185** (done, ai-substrate, score 0.87 (cross-cluster)) — Extend PickingUp DSE on a HasGroundCarcass colony marker — emergent scavenging
