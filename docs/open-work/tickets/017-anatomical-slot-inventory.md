...
- · **  1** (in-progress, —, score 0.82) — Explore dominance over targeted leisure
- ✓ landed ** 89** (done, ai-substrate, score 0.80 (cross-cluster)) — Interoceptive self-anchors — spatial self-perception (OwnInjurySite, OwnSafeRes…
- ✓ landed ** 52** (done, —, score 0.80) — §L2.10.7 plan-cost feedback substrate + cat target-taking roster
