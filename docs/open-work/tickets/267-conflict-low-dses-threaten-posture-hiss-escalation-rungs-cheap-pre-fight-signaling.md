...
- · **268** (ready, combat-threat, score 0.88) — Hide DSE — wire C3 Belief + ActionAffordance for general threat-response (door-…
- ✓ landed **295** (done, belief-perception, score 0.87 (cross-cluster)) — WitnessableEvent emit sites — wire Attack / Mate / Care / FleeFrom / Hunt from…
