...
- · **  1** (in-progress, ai-substrate, score 0.90) — Explore dominance over targeted leisure
- · **135** (ready, ai-substrate, score 0.89) — Continuous-position migration — epic (Vec2<f32> substrate, smooth motion, speci…
- · ** 11** (blocked, magic-mythic, score 0.88 (cross-cluster)) — Cat-conversation rendering via Haiku (presenter over C3)
