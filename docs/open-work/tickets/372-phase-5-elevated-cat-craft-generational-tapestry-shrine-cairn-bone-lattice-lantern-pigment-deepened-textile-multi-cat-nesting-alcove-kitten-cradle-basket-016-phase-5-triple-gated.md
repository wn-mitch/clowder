...
- · **  9** (ready, ai-substrate, score 0.84 (cross-cluster)) — World-generation richness (Cluster E)
- · ** 21** (blocked, buildings-zones, score 0.83 (cross-cluster)) — Monuments — civic & memorial structures
- · **381** (parked, world-systems, score 0.83 (cross-cluster)) — trader-substrate foundation: visitor cats + tradable-goods exchange (unlocks me…
