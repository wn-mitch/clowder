...
- ✓ landed **152** (done, ai-substrate, score 0.88) — Tier-1 disposition-collapse audit — sweep for sibling Eat-into-Resting defects
- · **221** (blocked, ai-substrate, score 0.87) — caretake gates on ambush-recency at kitten tile
- ✓ landed **151** (done, process, score 0.87 (cross-cluster)) — Bugfix discipline — force a structural candidate in every fix-shape decision tr…
