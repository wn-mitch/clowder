...
- ✓ landed ** 71** (done, planning-substrate, score 0.89 (cross-cluster)) — Planning-substrate hardening — gird against the stuck-cat bug class (sub-epic)
- · **  1** (in-progress, —, score 0.88 (cross-cluster)) — Explore dominance over targeted leisure
- ✓ landed **163** (done, ai-substrate, score 0.88 (cross-cluster)) — Migrate the 9 apply_*_bonus passes into §3.5.1 modifiers (full-batch)
