...
- ✓ landed **163** (done, ai-substrate, score 0.80 (cross-cluster)) — Migrate the 9 apply_*_bonus passes into §3.5.1 modifiers (full-batch)
- · **173** (parked, ai-substrate, score 0.80 (cross-cluster)) — IsHerbalist / IsSpiritualist / HasCorruptionNearby capability markers (155 foll…
- · **127** (blocked, C, score 0.80 (cross-cluster)) — Joint-intention substrate for two-cat practices
