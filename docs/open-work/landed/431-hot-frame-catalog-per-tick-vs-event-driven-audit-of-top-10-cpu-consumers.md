...
- 2026-05-20 (434 retracted same-day): the re-baselining follow-on opened alongside this ticket's closeout was retracted before any work landed. Stage A's exact perturbation magnitude isn't structurally load-bearing — future stages measure their own deltas vs the post-431 baseline, and Stage H's tooling already closed the misdiagnosis class. Re-soaking three past commits to document a single reference number wasn't worth the soak time or a landed/ file.
