...
- 2026-05-18: Recovered from git history during Linear migration archaeology — commit 43cc38a7 (Wave 2 closeout) deleted this file instead of moving it to landed/. Restored to preserve Linear ID alignment.
