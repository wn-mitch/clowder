...
- 2026-05-18: Recovered from git history during Linear migration archaeology — commit 5a8d17d7 (`docs: 172 — closeout: move ticket to landed/, park 173, delete 174, regen index`) intentionally dropped this ticket. Restored to preserve Linear ID alignment.
