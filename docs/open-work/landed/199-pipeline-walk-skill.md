...
related-systems: []
related-balance: []
landed-at: d821f31d58d3eee679c807e54819085fa118b0a6
...
- ✓ landed **  2** (done, ai-substrate, score 0.90 (cross-cluster)) — Hunt-approach pipeline failures
- ✓ landed **183** (done, ai-substrate, score 0.86 (cross-cluster)) — Paired-axis lift on higher-tier DSEs OR Patrol-collision investigation (181 fol…
- ✓ landed ** 31** (done, tooling-diagnostics-ui, score 0.86) — Balance-tooling composition layer (verdict / hypothesize / sweep-stats / finger…
