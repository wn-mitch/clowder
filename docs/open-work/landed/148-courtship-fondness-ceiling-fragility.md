...
- ✓ landed **272** (done, ai-substrate, score 0.88) — MatingOccurred still gated by has_eligible_mate() breeding-floor AND-gate (post…
- ✓ landed **153** (done, ai-substrate, score 0.86) — 150 R5a balance follow-on — Resting score-mass and courtship recovery
