...
- 2026-05-18: Recovered from git history during Linear migration archaeology — commit 43cc38a7 (`docs: close Wave 2 tickets 073/074/075/078/080 + cleanup post-merge`) deleted this file as part of a closeout that should have moved it to landed/. Restored to preserve Linear ID alignment.
