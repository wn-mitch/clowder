...
- ✓ landed **158** (done, ai-substrate, score 0.89 (cross-cluster)) — GroomedOther never-fired post-154 — split Action::Groom + extract DispositionKi…
- ✓ landed ** 52** (done, —, score 0.85) — §L2.10.7 plan-cost feedback substrate + cat target-taking roster
