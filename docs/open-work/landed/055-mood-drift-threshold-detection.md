...
- · **315** (blocked, ai-substrate, score 0.83) — activate 263 axes with four-artifact methodology (Flee/Patrol/Hunt + resolver b…
- ✓ landed **282** (done, ai-substrate, score 0.83) — Temporal-integration doctrine for perception signals — decay stale, accumulate…
- ✓ landed ** 73** (done, ai-substrate, score 0.82) — Wave 2 substrate hardening
