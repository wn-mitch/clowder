...
- ✓ landed ** 49** (done, ai-substrate, score 0.88) — §9.2 faction overlay markers
- ✓ landed **231** (done, ai-substrate, score 0.87) — Strengthen pickup-class substrate — capacity markers + body-state subscription
