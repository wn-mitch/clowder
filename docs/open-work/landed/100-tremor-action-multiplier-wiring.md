...
- · **310** (ready, wildlife, score 0.88) — ShadowFox goal-directed behavior — den + satiation drive + ambush memory replac…
- · **314** (ready, ai-substrate, score 0.87 (cross-cluster)) — extend ActionAffordances writer to cover cat-vs-prey (Stalk/Chase/Pounce) — 263…
- · **245** (blocked, wildlife, score 0.87) — Ambient predator/prey behavior-observation enrichment
