...
- 2026-05-18: Recovered from git history during Linear migration archaeology — commit b9129a10 deleted this file as part of landing (`feat: unify headless + windowed via App pipeline`) without moving it to landed/. Restored to preserve Linear ID alignment.
