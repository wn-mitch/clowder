...
- · ** 19** (blocked, buildings-zones, score 0.87 (cross-cluster)) — Happy paths — usage-worn trails
- ✓ landed **  6** (done, ai-substrate, score 0.85 (cross-cluster)) — Cluster-B shared spatial slow-state closeout
- ✓ landed ** 62** (done, belief-perception, score 0.85) — Prey-species split — per-species scent maps (§5.6.3 row #5)
