...
| Magic | **[Built]** | `magic::CorruptionPushback`, `magic::corruption_spread`, `magic::ward_decay`, `magic::herb_seasonal_check`, `magic::advance_herb_growth` (+9 more) | [doc](../systems/magic.md) |
